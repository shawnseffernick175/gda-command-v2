...
| F-019 | On every deploy | P1 | Production state modified outside canonical deploy path — sessions applied migrations from unmerged branches | **Fixed** (PR #TBD — role separation + manifest verification + provenance + drift check) |
