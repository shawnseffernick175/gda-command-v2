...
| F-022 | 168 silent workflows need triage | Classify all workflows | **Closed** (2026-05-22) | All 5 categories assessed: Cat A (2 deleted), Cat B (4 deleted), Cat C (verified healthy), Cat D (8 deleted), Cat E (13 deleted). **27 total workflows deleted.** Fleet: 158 active, 0 inactive. Cat C re-verification scheduled 2026-05-28 (#275). PRs: #274, #276, #278, #279, #280, #281. Issue #257 closed. |
...
| F-024 | n8n cron scheduler not firing | Fix scheduler | **Closed** (2026-05-22) | Root cause was measurement artifact (same as F-022): `saveDataSuccessExecution=none` on n8n 2.14.2. Resolved by n8n 2.21.5 upgrade + `saveDataSuccessExecution=all` flip. Child issues: #266 (F-024b drift-report.yml, PR #265) and #267 (F-024c Traefik conflict, PR #277) both closed. All 47 cron workflows healthy or deleted in F-022. Issue #260 closed. |
...
| F-022 | **Closed.** All 5 categories triaged and executed. Cat C re-verification on 2026-05-28 (#275) is the only remaining open item. |
