      ...
      await client.query(
        `UPDATE opportunities
         SET tags = array_append(
             ...
             incumbent_confidence = CASE WHEN $3 IS NOT NULL THEN $8 ELSE incumbent_confidence END,
        ...
        [
          ...
          opp.incumbentConfidence ?? 'medium',
        ],
      );
    ...
    const { rows: upsertRows } = await client.query(
      `INSERT INTO opportunities (
       ...
       ON CONFLICT (sam_notice_id) DO UPDATE SET
         ...
         incumbent_confidence = CASE WHEN EXCLUDED.incumbent IS NOT NULL THEN EXCLUDED.incumbent_confidence ELSE opportunities.incumbent_confidence END,
      ...
      [
        ...
        sourceId,
        opp.incumbent,
        opp.incumbent ? opp.incumbentConfidence ?? 'medium' : null,
