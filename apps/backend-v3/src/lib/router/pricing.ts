/**
 * LLM pricing table — per-million token rates.
 * Update this file when model pricing changes. Each entry maps a model
 * identifier to its input and output cost per million tokens (USD).
 */
...
const PRICING_TABLE: Record<string, ModelPricing> = {
  ...
  'text-embedding-3-large': { input_per_million: 0.13, output_per_million: 0 },
