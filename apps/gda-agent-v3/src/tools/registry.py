...
from src.tools.schemas import (
    SamSearchInput, SamSearchOutput,
    UsaSpendingSearchInput, UsaSpendingSearchOutput,
    FederalRegisterSearchInput, FederalRegisterSearchOutput,
    DbQueryInput, DbQueryOutput,
    RagSearchInput, RagSearchOutput,
    WebSearchInput, WebSearchOutput,
    DoctrineCheckInput, DoctrineCheckOutput,
    DecisionMemoryLookupInput, DecisionMemoryLookupOutput,
...
_register(
    "govtribe_search",
    "Search GovTribe for opportunities, awards, and forecasts (credit-budget enforced)",
