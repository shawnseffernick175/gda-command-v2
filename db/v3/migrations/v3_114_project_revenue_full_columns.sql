...
-- Indexes for fast project-level lookups used by the drill-down page
CREATE INDEX IF NOT EXISTS project_revenue_actuals_project_id_idx
  ON project_revenue_actuals (project_id, period);
CREATE INDEX IF NOT EXISTS project_revenue_actuals_project_name_idx
  ON project_revenue_actuals (project_name, period);
