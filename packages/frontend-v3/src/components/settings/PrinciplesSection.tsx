    ...
    <div className="rounded border border-border bg-gda-bg-base">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[11px] text-muted-foreground">{principle.short_form}</p>
        </div>
        ...
        <div className="border-t border-border px-4 pb-4 pt-3 space-y-3">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono text-muted-foreground uppercase tracking-wider">Short form</span>
              {!editingShort && (
                <button
                  type="button"
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono text-muted-foreground uppercase tracking-wider">Long form</span>
              {!editingLong && (
                <button
                  type="button"
                ...
                {editingPrompt ? (
                  <div className="space-y-1.5">
                    <textarea
                      ...
                      className="w-full rounded border border-border bg-gda-panel px-2.5 py-1.5 font-mono text-[11px] text-foreground focus:outline-none focus:ring-1 focus:ring-gda-green/50 resize-none"
                    />
                    <div className="flex gap-2">
                      <button
                        type="button"
