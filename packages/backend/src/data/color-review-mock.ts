...
export const MOCK_COLOR_REVIEWS: ColorReview[] = [
  ...
  // ─── PROP-001: PEO IEW&S SETA — Blue Team (capture strategy assessment) ───
  {
    ...
    blue_assessments: [
      ...
      { id: "BA-001-02", category: "naics_fit", label: "NAICS Code Match", verdict: "pass", detail: "Primary NAICS 541330 (Remediation Services) — matches our SBA-verified NAICS registration. Size standard $22M, our 3-year avg $18.2M qualifies as small business.", evidence: "SAM.gov registration, SBA profile", recommendation: null },
