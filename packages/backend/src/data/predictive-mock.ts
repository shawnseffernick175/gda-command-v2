...
const PWIN_MODELS: PwinModelOutput[] = [
  {
    opp_id: "opp-001",
    opp_title: "Army PEO IEW&S SETA Support Services IDIQ",
    ...
    improvement_actions: [
      ...
      { action: "Add geophysical survey sub to team (covers gap in cyber ops capability)", estimated_pwin_lift: 0.04, effort: "low", deadline: "2026-05-15" },
      { action: "Prepare C5ISR systems engineering case study as discriminator", estimated_pwin_lift: 0.03, effort: "low", deadline: null },
  ...
  },
  {
    ...
    features: [
      { name: "Agency Win Rate", value: "DISA", importance: 0.22, impact: "negative", benchmark: "Your DISA win rate: 28% vs. portfolio avg 42%" },
    ...
    improvement_actions: [
      { action: "Identify and formalize teaming partner with DISA past performance", estimated_pwin_lift: 0.08, effort: "high", deadline: "2026-05-18" },
      { action: "Attend DISA Enterprise industry day on May 25", estimated_pwin_lift: 0.05, effort: "low", deadline: "2026-05-25" },
  ...
  {
    opp_id: "opp-003",
    opp_title: "DEVCOM C5ISR Smart Base Infrastructure",
    agency: "US Air Force",
    ml_pwin: 0.81,
    static_pwin: 0.75,
  ...
  {
    opp_id: "opp-004",
    opp_title: "Hanscom AFB IT Modernization Support",
    agency: "NASA",
    ml_pwin: 0.41,
    static_pwin: 0.45,
    ...
    improvement_actions: [
      ...
      { action: "Engage Hanscom AFB small business liaison for teaming intro", estimated_pwin_lift: 0.05, effort: "medium", deadline: "2026-05-20" },
...
const PIPELINE_FORECAST: PipelineForecast = {
  ...
  risk_factors: [
    { id: "rf-001", risk: "DEVCOM C5ISR re-compete delayed to FY27", impact_revenue: -24_600_000, probability: 0.15, mitigation: "Maintain warm relationship; prepare for accelerated timeline", severity: "critical" },
    { id: "rf-002", risk: "PEO IEW&S SETA IDIQ canceled or scope reduced", impact_revenue: -12_400_000, probability: 0.10, mitigation: "Diversify pipeline with additional USACE task orders", severity: "high" },
    ...
    { id: "rf-004", risk: "Key personnel unavailable for Hanscom AFB proposal", impact_revenue: -8_500_000, probability: 0.20, mitigation: "Identify backup PM with NASA clearance", severity: "medium" },
  ...
  top_contributors: [
    { opp_id: "opp-003", title: "DEVCOM C5ISR Smart Base Infrastructure", agency: "US Air Force", value: 24_600_000, pwin: 0.81, weighted_value: 19_926_000, expected_close: "2026-08-15", status: "capture" },
    ...
    { opp_id: "opp-001", title: "Army PEO IEW&S SETA Support Services", agency: "USACE", value: 12_400_000, pwin: 0.73, weighted_value: 9_052_000, expected_close: "2026-06-30", status: "proposal" },
    { opp_id: "opp-004", title: "Hanscom AFB IT Modernization Support", agency: "NASA", value: 45_000_000, pwin: 0.41, weighted_value: 18_450_000, expected_close: "2026-10-01", status: "evaluate" },
    { opp_id: "opp-002", title: "DISA SETA Technical Support", agency: "DISA", value: 8_200_000, pwin: 0.54, weighted_value: 4_428_000, expected_close: "2026-09-01", status: "pursue" },
...
const BID_ASSESSMENTS: BidNoBidAssessment[] = [
  {
    ...
    factors: [
      ...
      { category: "Competitive Landscape", score: 65, weight: 0.10, weighted_score: 6.5, notes: "SAIC incumbent is strong; 4-6 expected bidders", signal: "amber" },
    ...
    rationale: "Strong strategic fit with core defense IT services capability. High Pwin with clear improvement actions. USACE is a priority relationship. BD investment justified by contract value and growth potential.",
  ...
  },
  {
    ...
    factors: [
      ...
      { category: "Strategic Fit", score: 60, weight: 0.20, weighted_score: 12.0, notes: "Expands DISA relationship but not core agency", signal: "amber" },
    ...
    rationale: "Below bid threshold on multiple factors. Resource conflict with higher-priority opp-001. Recommend watching — pursue only if opp-001 resolves early and teaming partner with DISA past perf is secured.",
