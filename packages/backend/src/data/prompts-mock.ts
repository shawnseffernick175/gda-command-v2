...
- Core Capabilities: Environmental remediation, PFAS treatment, UXO clearance, compliance consulting
...
const MOCK_USAGE: PromptUsage[] = [
  {
    ...
    context: "USACE FUDS IDIQ proposal executive summary",
    outcome: "success",
    notes: "Generated strong opening tied to USACE environmental mission",
  },
  {
    id: "usage-002",
    promptId: "prompt-001",
    ...
    context: "EPA Superfund Task Order capture plan",
    outcome: "success",
  ...
  },
  {
    ...
    context: "Red team review of Tyndall AFB technical volume Section 3",
    outcome: "partial",
  ...
  },
  {
    ...
    context: "DOE Oak Ridge solicitation compliance matrix extraction",
    outcome: "success",
  ...
  },
  {
    ...
    context: "Follow-up to USACE contracting officer re: FUDS IDIQ Q&A",
    outcome: "success",
    notes: null,
  },
  {
    ...
    context: "OODA analysis for NASA KSC opportunity bid/no-bid",
    outcome: "success",
  ...
  },
  {
    ...
    context: "Tetra Tech competitive brief for USACE environmental program",
    outcome: "success",
    notes: "Identified vulnerability in their PFAS remediation track record",
  },
  {
    id: "usage-008",
    promptId: "prompt-008",
    ...
    context: "SAM.gov screening of Navy NAVFAC environmental services RFP",
    outcome: "success",
