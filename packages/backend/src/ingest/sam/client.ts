 ...
 * Re-uses the existing SAM API types from lib/sam-api but provides
 * a framework-specific interface for paginated fetching.
 */

import { log } from "../../lib/logger";
import type { SAMOpportunityRaw, SAMSearchResponse } from "../../lib/sam-api";
