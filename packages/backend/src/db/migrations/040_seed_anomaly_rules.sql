...
VALUES
  ...
  (gen_random_uuid(), 'Deadline Change > 30 Days', 'response_deadline_change_gt_30d', 'critical', 'An opportunity response deadline shifts by more than 30 days', NOW()),
  (gen_random_uuid(), 'Value Estimate Change > 50%', 'value_estimate_change_gt_50pct', 'critical', 'An opportunity estimated value changes by more than 50% from original', NOW()),
  ...
  (gen_random_uuid(), 'High-Value Opp No Capture Plan', 'high_value_no_capture_plan', 'critical', 'An opportunity valued over $5M has no associated capture plan', NOW()),
