...
export function OpportunityTableRow({
  ...
  return (
    ...
    >
      <td style={{ ...tdStyle, fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif", fontSize: 12, color: "var(--color-text-muted)" }}>
        <Link
      ...
      <td style={{ ...tdStyle, fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" }}>
