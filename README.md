...
| `OPENAI_API_KEY` | No | — | OpenAI API key for LLM features (RAG, CPARS, RFP, Color Review) |
| `GDA_WEBHOOK_KEY` | No | — | Shared key for n8n ingest authentication (`x-gda-key` header) |
| `BACKUP_DIR` | No | `/var/backups/gda` | Directory for database backup files |
